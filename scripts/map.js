...
function initializeMap() {
 ...
 tulsa = new google.maps.LatLng( 36.12, -95.95 );
 var myOptions = {
  styles: mapStyle,
  zoom: 13,
  center: tulsa,
...
function resultListBuilder( d ) {
 ...
 if ( d.rows != null ) {
  ...
  for ( var i = 0; i < numRows; i++ ) { //start loop to build marker
   ...
   if ( ratinglevel == "Level 1+" ) {
    var perfimage2 = 'images/Level_1a';
   } else if ( ratinglevel == "Level 1" ) {
    var perfimage2 = 'images/Level_1';
   } else if ( ratinglevel == "Level 2+" ) {
    var perfimage2 = 'images/Level_2a';
   } else if ( ratinglevel == "Level 2" ) {
    var perfimage2 = 'images/Level_2';
   } else if ( ratinglevel == "Level 3" ) {
    var perfimage2 = 'images/Level_3';
   } else if ( ratinglevel == "Inability to Rate" ) {
...
function networkMarkerClick( map, m, ifw ) {
 ...
 return function () {
  ...
  infoWindowsas.setOptions( {
   pixelOffset: new google.maps.Size( -1, -14 )
  } );
...
function filterSchools() {
 ...
 if ( filters.length !== 3 ) {
  if ( st1 ) {
   filtersForDisplay.push( " Elementary School" );
  }
  if ( st2 ) {
   filtersForDisplay.push( " Middle School" );
  }
  if ( st3 ) {
   filtersForDisplay.push( " High School" );
  }
 ...
 if ( st13 ) {
  filters4.push( " 'Level 1+'" );
 }
 if ( st14 ) {
  filters4.push( " 'Level 1'" );
 }
 if ( st15 ) {
  filters4.push( " 'Level 2+'" );
 }
 if ( st16 ) {
  filters4.push( " 'Level 2'" );
 }
 if ( st17 ) {
  filters4.push( " 'Level 3'" );
 }
 if ( st18 ) {
  filters4.push( " 'Inability to Rate' " );
 }

 if ( filters4.length > 0 ) {
  ratingClause += " Rating IN (";
  ratingClause += filters4.join( "," );
  ratingClause += " )";
 } else {
 ...
 if ( filters4.length !== 6 ) {
  if ( st13 ) {
   filtersForDisplay.push( " Level 1+" );
  }
  if ( st14 ) {
   filtersForDisplay.push( " Level 1" );
  }
  if ( st15 ) {
   filtersForDisplay.push( " Level 2+" );
  }
  if ( st16 ) {
   filtersForDisplay.push( " Level 2 " );
  }
  if ( st17 ) {
   filtersForDisplay.push( " Level 3 " );
  }
  if ( st18 ) {
   filtersForDisplay.push( " Inability to Rate" );
  }
 }
 ...
 if ( filters2.length > 0 ) {
  classifClause = " Classification IN (";
  classifClause += filters2.join( "," );
  classifClause += " )";
 }
 ...
 if ( pt01 ) {
  filters3.push( "Agricultural_Sciences||" );
 }
 if ( pt02 ) {
  filters3.push( "Agriculture_and_Horticulture||" );
 }
 if ( pt03 ) {
  filters3.push( "Business_and_Finance||" );
 }
 if ( pt04 ) {
  filters3.push( "CTE_CCA||" );
 }
 if ( pt05 ) {
  filters3.push( "Childrens_Engineering" );
 }
 if ( pt06 ) {
  filters3.push( "Comprehensive_Gifted||" );
 }
 if ( pt07 ) {
  filters3.push( "Construction_and_Architecture||" );
 }
 if ( pt08 ) {
  filters3.push( "Culinary_and_Hospitality||" );
 }
 if ( pt09 ) {
  filters3.push( "Dual_Immersion||" );
 }
 if ( pt10 ) {
  filters3.push( "Early_Childhood_Program||" );
  filtersForDisplay.push( " Early Childhood Program" );
 }
 if ( pt11 ) {
  filters3.push( "Education_and_Training||" );
 }
 if ( pt12 ) {
  filters3.push( "Engineering||" );
 }
 if ( pt13 ) {
  filters3.push( "Fine_Performing_Arts||" );
 }
 if ( pt14 ) {
  filters3.push( "Health_Science||" );
 }
 if ( pt15 ) {
  filters3.push( "Humanities||" );
 }
 if ( pt16 ) {
  filters3.push( "Information_Technology||" );
 }
 if ( pt17 ) {
  filters3.push( "IB||" );
 }
 ...
 if ( pt19 ) {
  filters3.push( "Law_Public_Safety_and_Security||" );
 }
 if ( pt20 ) {
  filters3.push( "Literature_Writing||" );
 }
 if ( pt24 ) {
  filters3.push( "Manufacturing||" );
 }
 if ( pt25 ) {
  filters3.push( "Math_Science||" );
 }
 if ( pt26 ) {
  filters3.push( "Media_and_Communication_Arts||" );
 }
 if ( pt27 ) {
  filters3.push( "Military_Academy||" );
 }
 if ( pt28 ) {
  filters3.push( "Montessori||" );
 }
 if ( pt29 ) {
  filters3.push( "Personal_Care_Services||" );
 }
 if ( pt30 ) {
  filters3.push( "Scholastic_Academy||" );
 }
 if ( pt31 ) {
  filters3.push( "Selective_Enrollment_AC" );
 }
 if ( pt32 ) {
  filters3.push( "Classical||" );
 }
 if ( pt33 ) {
  filters3.push( "English_Language_Learners||" );
 }
 if ( pt34 ) {
  filters3.push( "Selective_Enrollment_High_School||" );
 }
 if ( pt35 ) {
  filters3.push( "International_Gifted||" );
 }
 if ( pt39 ) {
  filters3.push( "STEM||" );
 }
 if ( pt40 ) {
  filters3.push( "Technology||" );
 }
 if ( pt41 ) {
  filters3.push( "Transportation||" );
 }
 if ( pt42 ) {
  filters3.push( "World_Language||" );
 }
...
function findMe() {
 //check to see if http or https (only works with https)
 var pageurl = top.location.href
 var x = pageurl.split( ':' )[ 0 ];
 if ( x !== "https" ) {
  $( '#FindMemodal' ).modal( 'show' );
  return;
 }
...
function addrFromInputField( theInput ) {
 ...
 if ( address != "" ) {
  if ( address.toLowerCase().indexOf( "tulsa" ) == -1 ) {
   address = address + " tulsa, oklahoma";
  }
  geocoder.geocode( {
   'address': address
